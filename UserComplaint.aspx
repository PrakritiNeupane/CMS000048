<%@ Page Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="UserComplaint.aspx.cs" Inherits="UserComplain" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        <tr>
            <td style="width: 146px">
                <strong><span style="font-size: 16pt; color: Black; font-family: Verdana">Complaint</span></strong></td>
       ...
       <tr>
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:Button ID="btnsubmit" BackColor="Green" ForeColor="White" runat="server" OnClick="btnsubmit_Click" Text="Submit"
        Width="141px" />
            </td>
        </tr>
        <tr>
